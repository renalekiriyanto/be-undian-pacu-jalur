                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="/arena">Arena</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="arena_name">Nama Arena</label>
                            <input type="text" class="form-control" id="arena_name" placeholder="Masukkan nama arena"
                                wire:model="arena_name">
                        </div>
                    ...
                    <div class="card-footer">
                        <button type="button" wire:click="updateRecord" class="btn btn-primary">Simpan</button>
                    </div>
                    {{-- </form> --}}
                </div>
            </div>
